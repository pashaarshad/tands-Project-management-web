...
<div class="dash-card">
    ...
    <div class="card-body" style="padding:18px;">
        <form action="{{ route($routePrefix . '.lead-notes.store', $lead->id) }}" method="POST" style="margin-bottom:20px;">
            @csrf
                ...
                <div class="note-item">
                    <div class="note-header">
                        ...
                        <div class="note-actions">
                            ...
                            <button type="button" class="not-btn danger" onclick="confirmDeleteNote('{{ route($routePrefix . '.lead-notes.destroy', $note->id) }}')"><i class="bi bi-trash"></i></button>
                        </div>
                    </div>
