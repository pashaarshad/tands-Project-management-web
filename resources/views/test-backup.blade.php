    ...
    <div class="modal-box" onclick="event.stopPropagation()">
      ...
      <div class="modal-bd">
        <div class="form-grid">
          ...
          <div class="form-row"><label class="form-lbl">Team Lead</label><select class="form-inp">
    ...
    <div class="modal-box" onclick="event.stopPropagation()">
      ...
      <div class="modal-bd">
        <div class="form-grid">
          ...
          <div class="form-row"><label class="form-lbl">Phone</label><input type="tel" class="form-inp" placeholder="+91 XXXXX XXXXX"></div>
          <div class="form-row"><label class="form-lbl">Source</label><select class="form-inp">
              <option>Website</option>
              <option>Referral</option>
              <option>LinkedIn</option>
              <option>Cold Call</option>
            </select></div>
          <div class="form-row"><label class="form-lbl">Stage</label><select class="form-inp">
              <option>Cold</option>
              <option>Warm</option>
              <option>Hot</option>
            </select></div>
    ...
    <div class="modal-box" onclick="event.stopPropagation()">
      ...
      <div class="modal-bd">
        <div class="form-grid">
          ...
          <div class="form-row"><label class="form-lbl">Delivery Date</label><input type="date" class="form-inp"></div>
          <div class="form-row"><label class="form-lbl">Linked Project</label><select class="form-inp">
              <option>None</option>
              <option>Orion E-Commerce</option>
              <option>FinanceMe App</option>
              <option>SmartCart PWA</option>
            </select></div>
        </div>
      </div>
      <div class="modal-ft">
    ...
    <div class="modal-box" onclick="event.stopPropagation()">
      ...
      <div class="modal-bd">
        <div class="form-grid">
          ...
          <div class="form-row"><label class="form-lbl">Department</label><select class="form-inp">
              <option>Development</option>
              <option>Sales</option>
              <option>Design</option>
              <option>HR/Ops</option>
            </select></div>
          <div class="form-row"><label class="form-lbl">Role/Designation</label><select class="form-inp">
              <option>Developer</option>
          ...
          <div class="form-row"><label class="form-lbl">Panel Access</label><select class="form-inp">
              <option>Sales Panel</option>
              <option>Developer Panel</option>
    ...
    <div class="modal-box lg-box" onclick="event.stopPropagation()">
      <div class="modal-hd">
        <div style="display:flex;align-items:center;gap:12px">
          ...
          <div><span style="font-size:16px;font-weight:700">Orion E-Commerce</span>
            <div style="font-size:12px;color:var(--t3)">#PRJ-001 · TechCorp Pvt Ltd</div>
          </div>
        </div>
          ...
          <div class="detail-col">
            <div class="detail-section">
              ...
              <div style="display:flex;align-items:center;gap:12px;margin-top:8px">
                <div class="prog-bar-wrap" style="flex:1;height:8px">
                  <div class="prog-fill" style="width:78%;background:#6366f1;height:8px;border-radius:4px"></div>
                </div>
            ...
            <div class="detail-kpis">
              ...
              <div class="dk-item">
                <div class="dk-val" style="color:#10b981">₹6.2L</div>
                <div class="dk-lbl">Spent</div>
              </div>
              <div class="dk-item">
                <div class="dk-val" style="color:#f59e0b">Dec 15</div>
                <div class="dk-lbl">Deadline</div>
              </div>
              <div class="dk-item">
                <div class="dk-val">8</div>
                <div class="dk-lbl">Devs</div>
              </div>
            </div>
            <div class="detail-section">
              ...
              <div class="member-chips">
                <div class="mc-item">
                  <div class="mini-ava" style="background:linear-gradient(135deg,#6366f1,#8b5cf6)">AK</div>Arjun Kumar <span class="mc-role">Lead</span>
                </div>
                <div class="mc-item">
                  <div class="mini-ava" style="background:linear-gradient(135deg,#10b981,#06b6d4)">MG</div>Mohit Gupta <span class="mc-role">Backend</span>
                </div>
                <div class="mc-item">
                  <div class="mini-ava" style="background:linear-gradient(135deg,#f59e0b,#ef4444)">SA</div>Sneha Agarwal <span class="mc-role">Mobile</span>
                </div>
                <div class="mc-item">
                  <div class="mini-ava" style="background:linear-gradient(135deg,#8b5cf6,#ec4899)">KP</div>Kiran Patel <span class="mc-role">DevOps</span>
                </div>
              </div>
            </div>
          </div>
          <div class="detail-col">
            <div class="detail-section">
              ...
              <div class="mini-timeline">
                <div class="mt-item green">
                  <div class="mt-dot"></div>
                  <div>
                    <div class="mt-text">Payment milestone 2 received</div>
                    <div class="mt-time">Nov 15</div>
                  </div>
                </div>
                <div class="mt-item blue">
                  <div class="mt-dot"></div>
                  <div>
                    <div class="mt-text">Sprint 4 review completed</div>
                    <div class="mt-time">Nov 12</div>
                  </div>
                </div>
                <div class="mt-item orange">
                  <div class="mt-dot"></div>
                  <div>
                    <div class="mt-text">Design handover — checkout flow</div>
                    <div class="mt-time">Nov 8</div>
                  </div>
                </div>
                <div class="mt-item purple">
                  <div class="mt-dot"></div>
                  <div>
                    <div class="mt-text">Backend API v2 deployed</div>
                    <div class="mt-time">Nov 5</div>
                  </div>
                </div>
              </div>
            </div>
            <div class="detail-section">
              ...
              <select class="form-inp" style="margin-top:8px">
                <option>In Progress</option>
                <option>Review</option>
                <option>Completed</option>
    ...
    <div class="modal-box" onclick="event.stopPropagation()">
      ...
      <div class="modal-bd">
        <div class="detail-kpis" style="margin-bottom:20px">
          <div class="dk-item">
            <div class="dk-val">₹18L</div>
            <div class="dk-lbl">Est. Value</div>
          </div>
          <div class="dk-item">
            <div class="dk-val" style="color:#ef4444">Hot 🔥</div>
            <div class="dk-lbl">Stage</div>
          </div>
          <div class="dk-item">
            <div class="dk-val">Website</div>
            <div class="dk-lbl">Source</div>
          </div>
          <div class="dk-item">
            <div class="dk-val">14 days</div>
            <div class="dk-lbl">Age</div>
          </div>
        </div>
        <div class="form-grid">
          ...
          <div class="form-row"><label class="form-lbl">Move to Stage</label><select class="form-inp">
              <option>Hot</option>
